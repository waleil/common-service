package cn.net.yzl.zt.config.mysql;

import cn.net.yzl.zt.util.SpringContextUtil;
...
@MapperScan(basePackages="cn.net.yzl.zt.mapper")
...
//    private String mapperLocations;
    ...
    public Resource[] resolveMapperLocations() {
        ...
        mapperLocations.add("classpath:mybatis/zt/mapping/*.xml");//zt本项目
