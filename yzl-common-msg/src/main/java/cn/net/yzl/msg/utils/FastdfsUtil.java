...
public class FastdfsUtil {
    ...
    public StorePath upload(InputStream inputStream) throws IOException {
        // 设置文件信息
        Set<MetaData> mataData = new HashSet<>();
        mataData.add(new MetaData("author", "fastdfs"));
        mataData.add(new MetaData("description","222.xslx"));
        // 上传
        StorePath storePath = fastFileStorageClient.uploadFile(
                inputStream, 8888,
                FilenameUtils.getExtension("222.xslx"),
                null);
        return storePath;
    }
