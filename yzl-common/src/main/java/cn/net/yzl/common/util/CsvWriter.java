...
public class CsvWriter {
    ...
    public CsvWriter(Writer var1, char var2) throws UnsupportedEncodingException {
        this.outputStream = null;
        this.fileName = null;
        this.firstColumn = true;
        this.useCustomRecordDelimiter = false;
        ...
        if(var1 == null) {
            ...
            this.outputStream.write(new String(new byte[] {(byte) 0xef, (byte) 0xbb, (byte) 0xbf}, "UTF-8"));//加上bom头，才不会中文乱码
            this.userSettings.Delimiter = var2;
            this.initialized = true;
        }
    }

    public CsvWriter(OutputStream var1, char var2, Charset var3) throws UnsupportedEncodingException {
